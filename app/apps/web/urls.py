...
urlpatterns = [
    ...
    path('dictionary/create/', dictionary_views.DictionaryCreatePage.as_view(), name="dictionary-create"),
    path('dictionary/upload/', dictionary_views.DictionaryUpload.as_view(), name="dictionary-upload"),
